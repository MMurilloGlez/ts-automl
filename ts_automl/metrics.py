...
def mse(y_true, y_pred):
    ...
    Function calculating the mean squared error between the predicted values
    and the real ones (test)
...
def switch_abs_error(value, y_true, y_pred):
    ...
    A switch, that takes as input the list of error metrics to be calculated
    for a forecasting task and calls the corresponding calculations.
    ...
    Returns: function call
        function call to the corresponding metric or metric to be calculated
